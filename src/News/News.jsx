    ...
    <div className="news-container">
                ...
                <div className="flex flex-col items-end justify-start w-full gap-4">
                  ...
                  <div className="flex flex-row justify-start items-start w-[94%]  gap-[18px]">
                    <div className="flex flex-col items-start justify-start w-[78%] mb-[19px] gap-[18px]">
                      ...
                      <Heading as="h1">
                        Ngày hội việc làm Trường đại học Tôn Đức Thắng lần 1 năm
                        2024
                      </Heading>
                      <div className="flex flex-row justify-start items-center gap-2">
                        <Text as="p">
                          Thao trường quốc phòng, nội bộ số 7, Trường Đại học
                          Tôn Đức Thắng
                        </Text>
                ...
                <div className="flex flex-col items-end justify-start w-full gap-4">
                  ...
                  <div className="flex flex-row justify-start items-start w-[94%] gap-4">
                    <div className="flex flex-col items-start justify-start w-[79%] mb-[19px] gap-[18px]">
                      ...
                      <div className="flex flex-row justify-start items-center gap-2">
                        <Text as="p">
                          Hội thao sinh viên Trường Đại học Tôn Đức Thắng 2024
                        </Text>
                        <Img
                          src="images/img_.svg"
                          alt="image"
                    ...
                    <div className="flex flex-row justify-start items-start w-[94%] gap-[18px]">
                      <div className="flex flex-col items-start justify-start w-[78%] mb-[19px] gap-[18px]">
                        ...
                        <div className="flex flex-row justify-start items-center gap-2">
                          <Text as="p">
                            {" "}
                            Ngày hội tư vấn tuyển sinh đại học năm 2024 trường
      ...
      <div className="new-container-body">
        ...
        <div className="">
          ...
          <div className="laster-post">
            ...
            >
              Thi Tốt nghiệp THPT 2024: Thí sinh có thể không được thi riêng nếu
              trượt tốt nghiệp
            </a>
          </div>
          <div className="laster-post">
          ...
          <div className="laster-post">
            <a
              ...
              title="Tuyển sinh 2024: Đại học Bách khoa Hà Nội tăng chỉ tiêu xét tuyển bằng điểm Đánh giá tư duy"
            >
              Tuyển sinh 2024: ĐH Ngoại thương (FTU) dự kiến mở ngành Khoa học
              máy tính
            </a>
          </div>
          <div className="laster-post">
            <a
              ...
              title="Tuyển sinh 2024: Đại học Bách khoa Hà Nội tăng chỉ tiêu xét tuyển bằng điểm Đánh giá tư duy"
            >
              Nhận định đề thi minh hoạ kỳ thi tốt nghiệp THPT 2025 môn Giáo dục
              kinh tế & Pháp luật
            </a>
          </div>
          <div className="laster-post">
        ...
        <div className="">
          <div className="first-post">
            ...
            <div className="info">
              <h3 className="title-post">
                <a>
                  Điểm sàn Đánh giá tư duy năm 2024 có thể tăng cao – Thí sinh
                  hãy lưu ý những điều này!!
                </a>
              </h3>
              <div className="meta_created">22/02/2024 17:41</div>
            </div>
          ...
          <div className="laster-post">
            <a
              ...
              title="Tuyển sinh 2024: Đại học Bách khoa Hà Nội tăng chỉ tiêu xét tuyển bằng điểm Đánh giá tư duy"
            >
              Tuyển sinh 2024: Đại học Bách khoa Hà Nội tăng chỉ tiêu xét tuyển
              bằng điểm Đánh giá tư duy
            </a>
          </div>
          <div className="laster-post">
            <a
              ...
              title="Tuyển sinh 2024: Đại học Bách khoa Hà Nội tăng chỉ tiêu xét tuyển bằng điểm Đánh giá tư duy"
            >
              Tuyển sinh 2024: Đại Học Dược Hà Nội (HUP) giảm chỉ tiêu tuyển
              sinh
            </a>
          </div>
          <div className="laster-post">
      ...
      <div className="new-container-body">
        ...
        <ul className="new-sup-title list-category-sub">
          ...
          <li className="">|</li>
          <li className="list-category-sub-item">Chọn nghề </li>{" "}
          <li className="">|</li>
        ...
        <div className="">
          <div className="first-post">
            ...
            <div className="info">
              <h3 className="title-post">
                <a>
                  Tốt nghiệp THPT 2025: Xu hướng xét kết quả của kỳ thi riêng có
                  độ lớn và uy tín cao
                </a>
              </h3>
          ...
          <div className="laster-post">
            <a
              ...
              title="Tuyển sinh 2024: Đại học Bách khoa Hà Nội tăng chỉ tiêu xét tuyển bằng điểm Đánh giá tư duy"
            >
              Sự kiện “GỠ RỐI KỲ THI ĐÁNH GIÁ TƯ DUY 2024” cùng chuyên gia luyện
              thi và thủ khoa ĐGTD 2023
            </a>
          </div>
          <div className="laster-post">
            <a
          ...
          <div className="laster-post">
            <a
              ...
              title="Tuyển sinh 2024: Đại học Bách khoa Hà Nội tăng chỉ tiêu xét tuyển bằng điểm Đánh giá tư duy"
            >
              Review ngành Quản trị đô thị thông minh và bền vững: Ngành học đáp
              ứng nhu cầu tuyển dụng của xã hội
            </a>
          </div>
        </div>
      </div>
