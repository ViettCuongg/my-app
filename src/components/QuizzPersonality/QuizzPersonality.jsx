  ...
  return (
    <div>
      ...
      <div className="container">
          ...
          <div className="border rounded-md overflow-hidden md:border-[#d7d7d7] md:rounded-[12px] md:flex md:mb-8">
            ...
            <div className="p-8">
              <p className="max-w-[500px] md:max-w-96">
                TDTter cung cấp cho bạn các bài trắc nghiệm tính cách (MBTI)
                hoặc sở thích (Holland) giúp bạn hiểu rõ về bản thân mình hơn,
                từ đó đưa ra cho bạn những định hướng về nghề nghiệp phù hợp
                nhất
              </p>
              <div className="text-center">
                <div className="flex justify-center pt-8">
                  <img
                    className="transform rotate-90 bg-none"
                    src={arrowdown}
                    alt="a"
                  ></img>
                </div>
        ...
        <div
          ref={ref}
          className="quizz_container grid grid-cols-2 md:grid-cols-2 gap-2 md:gap-12 "
        >
          <a href="#">
            <div className="styled_card h-full">
              ...
              <div className="p-2  md:px-3 md:py-3 flex-grow flex-col flex md:text-[17px]">
                <div className="content mb-2 flex-grow">
                  <p>
                    Sử dụng bộ câu hỏi đánh giá, giúp người trả lời định hướng
                    bản thân rõ ràng dựa theo học thuyết MBTI (Myers-Briggs Type
                    Indicator)
                  </p>
                  ...
                  <p>
                    Với việc trả lời các câu hỏi trắc nghiệm, người trả lời sẽ
                    nhận được 4 chữ đại diện cho đặc điểm tính cách của bản
                    thân. Từ đó đưa ra gợi ý công việc phù hợp với tính cách đó.
                  </p>
                </div>
          ...
          <a href="#">
            <div className="styled_card h-full">
              ...
              <div className="p-2  md:px-3 md:py-3 flex-grow flex-col flex md:text-[17px]">
                <div className="content mb-2 flex-grow">
                  <p>
                    Được phát triển bởi nhà tâm lý học người Mỹ - John Holland.
                  </p>
                  <p className="pt-6">
                    Sử dụng bộ 42 câu hỏi về sở thích để cho ra kết quả về 6
                    nhóm người:
                  </p>
                  <p>Với kết quả là 4 cặp cá tính đối lập:</p>
                  <div className="pt-5 pl-10 pb-5">
